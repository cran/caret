...
\end{document}
   ...
   setwd("c:/program files/R/R251/bin/caret/inst/doc/")
   oldWidth <- options("width")$width
   options(width = 80)
   Sweave(
      file = "c:/program files/R/R251/bin/caret/inst/doc/caretVarImp.Rnw",
      out = "c:/program files/R/R251/bin/caret/inst/doc/caretVarImp.tex")
