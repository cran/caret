...
\begin{itemize}
  ...
  \item Other packages: caret~4.11, class~7.2-46, e1071~1.5-19,
    ...
    lattice~0.17-22, MASS~7.2-46, mlbench~1.1-5, nnet~7.2-46,
    pls~2.1-0, proxy~0.4-1, randomForest~4.5-30, rpart~3.1-43,
    survival~2.35-4
\end{itemize}
\section{References}
