...
\begin{itemize}\raggedright
  ...
  \item Other packages: caret~4.36, class~7.3-1, e1071~1.5-20,
    ...
    plyr~0.1.9, proxy~0.4-4, randomForest~4.5-33, reshape~0.8.3,
