...
\begin{itemize}
  ...
  \item Other packages: caret~4.21, class~7.2-48, e1071~1.5-19,
    ellipse~0.3-5, gbm~1.6-3, ipred~0.8-8, kernlab~0.9-8, klaR~0.5-9,
    lattice~0.17-25, MASS~7.2-48, mlbench~1.1-6, nnet~7.2-48,
    pls~2.1-0, proxy~0.4-3, randomForest~4.5-30, rpart~3.1-45,
    survival~2.35-7
\end{itemize}
\section{References}
